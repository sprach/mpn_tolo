...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.testusercontrols\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-TestUserControls.dll.so\00", align 1
